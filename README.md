# Before you start, clone the repo into your home directory: 
...
### 1. Ensure the following directories exist on your machine: 
~/MicrobeAtlasProject/
~/github/metadata_mining/scripts/
~/github/metadata_mining/source_data/
~/github/metadata_mining/middle_dir/

### 2. Download original metadata file and move to folder: 

Download from: zenodo_test
Place the file (sample.info.gz) in ~/MicrobeAtlasProject/.
