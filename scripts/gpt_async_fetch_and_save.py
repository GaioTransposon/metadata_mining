...
# directory = os.path.join(home_dir, "MicrobeAtlasProject")
...
#             print(f"Error processing batch {batch_job_id}: {str(e)}. Continuing with the next.")
#     else:
...
failed_samples_path = os.path.join(directory, "failed_samples_log.txt")
