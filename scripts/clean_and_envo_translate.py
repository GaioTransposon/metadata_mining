...
#     log_messages = [f"Process {process_id} started processing a batch of files"]
# 
#     for file_path in file_paths:
#         try:
#             sample = os.path.basename(file_path).replace('.txt', '')
#             log_messages.append(f"Processing file {sample} in Process {process_id}...")
# 
#             with open(file_path, 'r') as f:
#                 metadata = f.read()
# 
...
#             log_messages.append(f"Error processing file {sample}: {e}")
#             log_messages.append(traceback.format_exc())
# 
#     log_messages.append(f"Process {process_id} completed processing its batch")
#     return log_messages, len(file_paths)
# 
# 
...
#     
# 
#     # Print out the received command line arguments for debugging
